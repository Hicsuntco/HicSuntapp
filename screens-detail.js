...
var GEO_SHAPES_SD = {
  ...
  'indonesie':{vb:'0 0 280 120',
    /* Java (grande), Bali (petite à droite), Lombok, Sumbawa, Flores, Komodo, Sumba schématisés */
    path:'M8,55 C12,42 24,36 40,34 C56,32 70,36 82,44 C94,52 98,62 94,72 C90,82 80,86 66,86 C52,86 38,80 26,70 C14,60 4,68 8,55Z '
       +'M108,48 C112,42 120,38 128,40 C136,42 140,50 138,58 C136,66 128,70 120,68 C112,66 106,60 108,48Z '
       +'M148,52 C152,46 160,44 166,48 C172,52 172,60 168,66 C164,72 156,72 150,66 C144,60 144,58 148,52Z '
       +'M182,56 C186,50 196,48 204,52 C212,56 214,66 208,72 C202,78 192,78 186,72 C180,66 178,62 182,56Z '
       +'M218,54 C222,48 228,46 234,50 C240,54 240,62 236,68 C232,74 224,74 220,68 C216,62 214,60 218,54Z '
       +'M248,60 C252,54 258,52 264,56 C270,60 270,68 264,74 C258,80 250,78 246,72 C242,66 244,66 248,60Z',
    cities:{
      'Jakarta':[44,62],'Yogyakarta':[60,68],'Surabaya':[80,58],'Bali':[118,56],
      'Ubud':[118,60],'Seminyak':[112,64],'Lombok':[152,58],'Sumbawa':[192,62],
      'Flores':[232,60],'Komodo':[248,66],'Labuan Bajo':[238,64],
      'Gili':[148,54],'Amed':[132,52],'Candidasa':[128,60],'Nusa Penida':[122,68],
    }},
...
function _geoShapeSD(dest){
  ...
  /* Aliases étendus */
  if(/indonesie|indonesia|bali|lombok|java|sumatra|flores|komodo|sumbawa|sulawesi|raja ampat/.test(d))return{key:'indonesie',g:GEO_SHAPES_SD.indonesie};
