...
var GEO_SHAPES_SD = {
  ...
  'indonesie':{vb:'0 0 300 120',path:'M6,52 C10,40 20,32 34,28 C48,24 62,26 74,32 C86,38 94,48 92,60 C90,72 80,80 68,82 C56,84 42,80 30,72 C18,64 2,64 6,52Z M108,42 C114,34 124,30 134,34 C144,38 148,50 144,60 C140,70 130,74 120,70 C110,66 104,56 108,42Z M162,46 C168,38 180,36 188,42 C196,48 196,60 190,68 C184,76 172,76 166,68 C160,60 156,54 162,46Z M208,50 C214,42 226,40 234,46 C242,52 242,64 236,70 C230,76 218,76 212,68 C206,60 202,58 208,50Z M250,52 C256,44 268,42 276,48 C284,54 284,66 278,72 C272,78 260,78 254,70 C248,62 244,60 250,52Z',cities:{'Jakarta':[48,64],'Yogyakarta':[64,70],'Surabaya':[84,62],'Bali':[126,52],'Ubud':[124,58],'Seminyak':[116,62],'Lombok':[168,56],'Labuan Bajo':[212,62],'Komodo':[230,66],'Gili':[160,48],'Amed':[138,48],'Nusa Penida':[130,68],'Raja Ampat':[272,56],'Flores':[220,60],'Sumbawa':[190,58],'Makassar':[238,62],'Medan':[10,42],'Banda Aceh':[4,42],'Padang':[16,58],'Manado':[262,46]}},
