...
const GEO_SHAPES = {
  ...
  'thaïlande': {
    vb:'0 0 140 240',
    /* Forme réelle : corps large au nord-est, péninsule qui descend vers le sud-ouest */
    path:'M40,8 C52,4 68,6 80,12 C92,18 102,28 108,40 C114,52 112,66 108,78 C104,88 96,94 90,104 C84,112 82,122 78,130 C74,138 68,142 66,150 C64,156 62,160 60,166 C58,172 56,178 54,184 C52,190 50,196 48,202 C46,208 44,214 42,220 C40,226 38,232 36,236 C35,238 34,240 34,240 L32,240 C31,236 30,230 32,224 C34,218 36,212 38,206 C40,200 40,194 42,188 C44,182 46,176 48,170 C50,164 50,158 52,152 C54,146 56,140 58,134 C60,128 60,122 62,116 C64,110 68,106 70,100 C72,94 70,86 72,78 C74,70 80,64 82,56 C84,48 80,36 74,26 C68,16 54,10 44,10 L40,8Z',
    cities:{
      /* Nord */
      'Chiang Rai':[58,14],'Mae Hong Son':[42,20],'Chiang Mai':[52,26],'Pai':[44,22],
      /* Centre */
      'Lampang':[62,36],'Sukhothai':[60,48],'Phitsanulok':[66,54],
      'Kanchanaburi':[56,72],'Ayutthaya':[68,70],'Bangkok':[76,80],
      /* Est */
      'Pattaya':[82,90],'Koh Chang':[90,96],
      /* Péninsule */
      'Hua Hin':[62,102],'Chumphon':[58,116],
      'Surat Thani':[54,128],'Koh Samui':[62,132],'Koh Phangan':[62,136],
      'Krabi':[48,150],'Koh Lanta':[48,156],'Phuket':[44,162],
      'Trang':[46,168],'Hat Yai':[42,178],
    }
  },
  'grèce': {
    vb:'0 0 160 120',
