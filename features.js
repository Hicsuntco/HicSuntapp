...
const GEO_SHAPES = {
  ...
  'thaïlande': {
    vb:'0 0 120 220',
    /* Corps large au nord + péninsule longue et étroite vers le sud */
    path:'M30,10 C38,6 50,6 62,10 C74,14 84,20 90,30 C96,40 94,52 92,62 C90,72 86,80 84,88 C82,96 84,104 80,110 C76,116 68,118 64,124 C60,130 58,136 56,142 C54,148 50,152 48,158 C46,164 46,170 44,176 C42,182 40,188 38,194 C36,200 34,206 32,212 C30,216 28,218 28,218 L26,218 C25,214 24,208 26,202 C28,196 30,190 32,184 C34,178 34,172 36,166 C38,160 40,154 42,148 C44,142 44,136 46,130 C48,124 52,120 54,114 C56,108 56,102 58,96 C60,90 64,86 66,80 C68,74 66,66 68,58 C70,50 76,44 78,36 C80,28 76,18 70,12 C64,6 52,8 44,10 L30,10Z',
    cities:{
      'Chiang Rai':[46,16],'Chiang Mai':[40,28],'Pai':[32,22],
      'Lampang':[50,40],'Sukhothai':[48,52],'Mae Sot':[34,54],
      'Kanchanaburi':[46,82],'Ayutthaya':[56,76],'Bangkok':[62,88],
      'Pattaya':[66,96],'Hua Hin':[52,108],'Chumphon':[46,120],
      'Surat Thani':[42,134],'Koh Samui':[50,138],'Koh Phangan':[50,142],
      'Krabi':[36,158],'Phuket':[32,164],'Koh Lanta':[34,168],'Hat Yai':[34,180],
    }
  },
  'grèce': {
    vb:'0 0 160 120',
